# jev-fabric — TypeScript reference

> These are the preserved reference runtime's instructions. For the native
> Bend pivot and current limitations, see [the migration ledger](bend-migration.md).
...
See [architecture](architecture.md) and [acceptance](acceptance.md).
